...
-- 보류
select a.emp_no as '사번', concat(a.first_name,' ',a.last_name) as '이름', c.dept_name as '부서', d.max_salary as '연봉'
	from employees a, dept_no b,departments c, 
		(select a.emp_no, max(c.salary) as max_salary
	...
	where a.emp_no = d.emp_no and a.emp_no = b.emp_no and b.dept_no = c.dept_no and b.to_date ='9999-01-01';
...
select a.emp_no, c.dept_no,avg(salary)as avg_salary
			from employees a, salaries b, dept_emp c
			where a.emp_no = b.emp_no and a.emp_no = c.emp_no and b.to_date='9999-01-01' and c.to_date='9999-01-01'
            group by c.dept_no;
