...
select count(dept_no) as '부서의 매니저' from dept_manager where to_date like '9999-01-01';
...
select count(emp_no) from titles where title like 'engineer' and to_date like '9999-01-01';
