...
select a.emp_no as '사번', concat(a.first_name,' ',a.last_name) as '이름', c.dept_name as '부서'
    ...
    where a.emp_no = b.emp_no and b.to_date = '9999-01-01' and b.dept_no = c.dept_no
    order by concat(a.first_name,' ',a.last_name) asc;

-- 문제4.
-- 전체 사원의 사번, 이름, 연봉, 직책, 부서를 모두 이름 순서로 출력합니다.
select a.emp_no as '사번', concat(a.first_name,' ',a.last_name) as '이름', e.salary as '연봉', d.title as '직책', c.dept_name as '부서'
	from employees a, dept_emp b, departments c, titles d, salaries e
    where a.emp_no = b.emp_no and b.dept_no = c.dept_no and a.emp_no = d.emp_no and a.emp_no = e.emp_no and b.to_date ='9999-01-01' and d.to_date ='9999-01-01' and e.to_date ='9999-01-01'
    order by concat(a.first_name,' ',a.last_name) asc;
...
select concat(a.first_name,' ', a.last_name) as '이름', d.dept_name as '부서명', b.title as '직책'
    ...
    where a.emp_no = b.emp_no and a.emp_no = c.emp_no and c.dept_no = d.dept_no and a.last_name like 'S%' and b.to_date = '9999-01-01' and c.to_date = '9999-01-01';

-- 문제7.
-- 현재, 직책이 Engineer인 사원 중에서 현재 급여가 40000 이상인 사원을 급여가 큰 순서대로 출력하세요.
select concat(a.first_name,' ',a.last_name) as '사원', c.salary as '급여'
	from employees a, titles b, salaries c
    where a.emp_no = b.emp_no and a.emp_no = c.emp_no and b.title = 'Engineer' and c.salary >= 40000 and b.to_date ='9999-01-01' and c.to_date ='9999-01-01'
...
select b.title as '직책', a.salary as '급여'
    ...
    where a.emp_no = b.emp_no and a.salary > 50000 and a.to_date ='9999-01-01' and b.to_date ='9999-01-01'
    order by a.salary desc;

-- 문제9.
-- 현재, 부서별 평균 연봉을 연봉이 큰 부서 순서대로 출력하세요.
select c.dept_name as '부서', avg(a.salary) as '평균연봉'
	from salaries a, dept_emp b, departments c
    where a.emp_no = b.emp_no and b.dept_no = c.dept_no and a.to_date = '9999-01-01' and b.to_date ='9999-01-01'
